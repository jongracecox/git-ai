...
class GitAIConfig:
    ...
    PROMPTS_DIR: Path = config("GIT_AI_PROMPTS_DIR", default=Path(__file__).parent / "prompts")
    ...
    PROMPT_TEMPLATE: Path = Path(config("GIT_AI_PROMPT_TEMPLATE", default=str(DEFAULT_PROMPT_TEMPLATE)))
    NUM_PREVIOUS_COMMITS: int = config("GIT_AI_NUM_PREVIOUS_COMMITS", default=3, cast=int)
